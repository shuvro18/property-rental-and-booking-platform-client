...
import { DollarSign, Home, CalendarCheck } from "lucide-react";

const OwnerDashboardHome = ({ totalEarnings = 0, totalProperties = 0, totalBookings = 0, monthlyEarnings = [], }) => {
        ...
        <div className="space-y-8 max-w-6xl mx-auto">
            ...
            <div>
                ...
                <p className="mt-1 text-gray-500 dark:text-gray-400">
                    Track your earnings, properties, and bookings
                </p>
            </div>
