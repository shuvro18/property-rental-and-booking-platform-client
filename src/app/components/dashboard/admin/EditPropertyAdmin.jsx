...
const EditPropertyAdmin = ({ property, onUpdate }) => {
  ...
  return (
    <>
      ...
      <button
        ...
        className="px-3 py-1.5 text-xs font-medium text-indigo-700 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:text-indigo-400 rounded-lg transition" title="Edit"
      >
        Update
      </button>
...
export default EditPropertyAdmin;